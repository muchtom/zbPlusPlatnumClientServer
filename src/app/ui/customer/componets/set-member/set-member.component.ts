...
@Component({
  ...
  styleUrls: ['./set-member.component.scss']
})
export class SetMemberComponent implements OnInit {
  ngOnInit(): void {
  ...
  // constructor(private dialogService: NbDialogService, protected dialogRef: NbDialogRef<SetMemberComponent>,private fb:FormBuilder,
