...
@Component({
  selector: 'app-cashback-transaction',
  templateUrl: './cashback-transaction.component.html',
  styleUrls: ['./cashback-transaction.component.scss']
})
export class CashbackTransactionComponent implements OnInit {
